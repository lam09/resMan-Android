...
public class MainFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        mAdapter = new FoodAdapter(context, mMessages);
...
//Add new fragment to current fragment
            ...
            bundle.putString("currentFood", food.toString());
// set Fragmentclass Arguments
            FoodDetailFragment fragobj = new FoodDetailFragment();
            fragobj.setArguments(bundle);
            ft.add(R.id.frag_container, fragobj);
            ft.commit();
        }
    }
